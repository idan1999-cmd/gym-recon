...
11. **Sales Commission National Insurance Multiplier (מכפיל ביטוח לאומי 1.08 לעמלות מכירה):**
   - בדוח מרכז חדר כושר ופילאטיס, סעיף עמלות מכירות, מנויים ושדרוגים (סעיף `22662` בחדר כושר וסעיף `181-22636` בפילאטיס) מוכפל תמיד במקדם **`1.08`** (תוספת 8% ביטוח לאומי).
   - במעבר לדוח בקרת שכר שכירים, שכר הבסיס של העובד נרשם ללא 1.08, ושורת הסיכום של עמלות המכירה כוללת את ה-1.08 לסנכרון מלא עם חיוב יזם.
